      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('¡Bienvenido ${data['user']['nombre'] ?? 'Usuario'}!'),
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(Icons.email, color: Color(0xFF8B4513)), // Marrón como tu tema
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(Icons.lock, color: Color(0xFF8B4513)), // Marrón como tu tema
                            ...
                            focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12),
                              borderSide: const BorderSide(color: Color(0xFF6A89CC), width: 2),
                            ),
                          ),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                         ...
                         SizedBox(
                           ...
                           child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFF8B4513), // Marrón como tu tema
